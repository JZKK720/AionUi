...
<p align="center">
  <strong>cubecloud 智方云 AgentOS 发行版，由 AionUi 提供底层能力</strong><br>
  <em>面向本地 AI-first API 与应用 | 内置 Agent 运行时 | 远程访问 | 跨平台部署</em>
</p>

<p align="center">
  <sub>Fork 说明：上游 AionUi 源码与 Apache-2.0 许可保持不变。cubecloud / 智方云 品牌资产与发行覆盖层 Copyright © 2026 cubecloud。</sub>
</p>

<p align="center">
  <sub>发行渠道：<a href="https://github.com/JZKK720/AionUi/releases">fork GitHub Releases</a> · <a href="https://github.com/JZKK720/AionUi/pkgs/container/cubecloud-agentos">fork GHCR 镜像</a> · <a href="https://github.com/iOfficeAI/AionUi">上游源码</a></sub>
</p>
...
<p align="center">
  <img src="../../resources/branding/cubecloud/Logo.png/1290X480 反黑.png" alt="cubecloud AgentOS 平台概览" width="800">
</p>
...
_当前产品截图仍可能显示上游 AionUi 命名，应用内界面品牌正在逐步切换到 cubecloud AgentOS。_

<p align="center">
  <img src="../../resources/homepage.png" alt="cubecloud AgentOS 内置助手" width="800">
</p>
...
点击上方按钮前往 fork Releases 页面，下载适合您平台的安装包（macOS / Windows / Linux）。
...
Homebrew 目前仍跟随上游 `aionui` cask，如需 cubecloud AgentOS 发行版，请优先使用 fork GitHub Releases 或 GHCR。
...
- [GitHub Discussions](https://github.com/JZKK720/AionUi/discussions) — 分享 fork 发行版的想法与使用技巧
- [报告问题](https://github.com/JZKK720/AionUi/issues) — 报告 cubecloud AgentOS 的 bug 与需求
- [发布更新](https://github.com/JZKK720/AionUi/releases) — 获取最新 fork 版本
- [上游源码与 Wiki](https://github.com/iOfficeAI/AionUi) — 查看上游代码来源与 AionUi 文档
...
上游 AionUi 源码归属与署名保持不变。cubecloud / 智方云 品牌资产与 fork 发行覆盖层 Copyright © 2026 cubecloud。
...
[报告 Bug](https://github.com/JZKK720/AionUi/issues) · [请求功能](https://github.com/JZKK720/AionUi/issues)
