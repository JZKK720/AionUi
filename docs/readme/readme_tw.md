...
<p align="center">
  <strong>cubecloud 智方云 AgentOS 發行版，由 AionUi 提供底層能力</strong><br>
  <em>面向本地 AI-first API 與應用 | 內建 Agent 執行時 | 遠端存取 | 跨平台部署</em>
</p>

<p align="center">
  <sub>Fork 說明：上游 AionUi 原始碼與 Apache-2.0 授權保持不變。cubecloud / 智方云 品牌資產與發行覆蓋層 Copyright © 2026 cubecloud。</sub>
</p>

<p align="center">
  <sub>發行渠道：<a href="https://github.com/JZKK720/AionUi/releases">fork GitHub Releases</a> · <a href="https://github.com/JZKK720/AionUi/pkgs/container/cubecloud-agentos">fork GHCR 映像</a> · <a href="https://github.com/iOfficeAI/AionUi">上游原始碼</a></sub>
</p>
...
| 從手機遠端存取        | 很少               | **WebUI + Telegram / Lark / DingTalk / WeChat / WeCom**                                                      |
| 定時自動化            | 否                 | **Cron — 24/7 無人值守**                                                                                     |
| 同時執行多個 AI Agent | 否                 | **Claude Code、Codex、Qwen Code、Kiro、Hermes Agent、Snow CLI、Cursor Agent 等 20+ 個 — 自動偵測，統一介面** |
| 價格                  | 免費 / 付費        | **免費且開源**                                                                                               |

<p align="center">
  <img src="../../resources/branding/cubecloud/Logo.png/1290X480 反黑.png" alt="cubecloud AgentOS 平台概覽" width="800">
</p>
...
- **現成的專業助手** — 內建 20 個專業助手（Cowork、PPT 生成器、Word 生成器、Excel 生成器、Morph PPT 3D、Pitch Deck 生成器、儀表板生成器、學術論文寫作助手、財務模型生成器等），拿來就能用

_目前產品截圖仍可能顯示上游 AionUi 命名，應用內介面品牌正在逐步切換到 cubecloud AgentOS。_

<p align="center">
  <img src="../../resources/homepage.png" alt="cubecloud AgentOS 內建助手" width="800">
</p>
...
**支援的 Agent：** 內建 Agent（零配置） • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI（aionrs，AionUi 自帶的 Rust 後端服務） • Snow CLI • Kiro • Hermes Agent • Cursor Agent 等
...
_靈活的助手系統，內建 20 個專業助手，支援三層技能體系，可自由建立和管理助手與技能。_
...
AionUi 內建 **20 個專業助手**，每個都有獨特能力，還能透過自訂技能繼續擴展：
...
| 互動     | 桌面 GUI      | 桌面 GUI + WebUI + Telegram / Lark / DingTalk / WeChat / WeCom |
...
點擊上方按鈕前往 fork Releases 頁面，下載適合您平台的安裝包（macOS / Windows / Linux）。
...
Homebrew 目前仍跟隨上游 `aionui` cask，如需 cubecloud AgentOS 發行版，請優先使用 fork GitHub Releases 或 GHCR。
...
- [GitHub Discussions](https://github.com/JZKK720/AionUi/discussions) — 分享 fork 發行版的想法與使用技巧
- [報告問題](https://github.com/JZKK720/AionUi/issues) — 回報 cubecloud AgentOS 的 bug 與需求
- [發布更新](https://github.com/JZKK720/AionUi/releases) — 取得最新 fork 版本
- [上游原始碼與 Wiki](https://github.com/iOfficeAI/AionUi) — 查看上游程式碼來源與 AionUi 文件
...
上游 AionUi 原始碼歸屬與署名保持不變。cubecloud / 智方云 品牌資產與 fork 發行覆蓋層 Copyright © 2026 cubecloud。
...
[報告 Bug](https://github.com/JZKK720/AionUi/issues) · [請求功能](https://github.com/JZKK720/AionUi/issues)
