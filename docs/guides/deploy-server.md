...
- At least 2GB RAM
- AionUi `.deb` package from [Releases](https://github.com/JZKK720/AionUi/releases)
...
wget https://github.com/JZKK720/AionUi/releases/latest/download/AionUi-linux-amd64.deb
...
- 至少 2GB 内存
- AionUi `.deb` 安装包（[下载地址](https://github.com/JZKK720/AionUi/releases)）
